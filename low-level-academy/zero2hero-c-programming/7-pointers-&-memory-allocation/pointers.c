#include <stdbool.h>
#include <stdio.h>
// Here, the syntax is as follows. The * character notes that the type is a pointer. The & character gets the "address
// of", which gets the address of x and puts that value in pX.
